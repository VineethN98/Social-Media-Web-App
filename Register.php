			...
			<div id="second">
				<form action ="Register.php" method = "POST">
					...
					<?php if(in_array("Passwords do not match<br>", $error_array)) 	echo "Passwords do not match<br>"; 
						else if(in_array("Your password can contain only alphanumeric characters<br>", $error_array)) 
							echo "Your password can contain only alphanumeric characters<br>"; 
					...
					<?php if(in_array("<span style = 'color:#14C800;'>You are all set! Go ahead and login!</span><br>", $error_array)) 	
